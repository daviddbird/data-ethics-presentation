...
knitr::include_graphics("images/interconnected.png")
```
...
knitr::include_graphics("images/datascienceimage.png")
```
...
knitr::include_graphics("images/oxfordmunich.png")
```
 
```{r echo=FALSE, out.width = "30%"}
knitr::include_graphics("images/ukgov.png")
```
